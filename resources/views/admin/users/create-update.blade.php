                ...
                <div class="example-content">
                    ...
                    <form
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-4">
                                <img src="{{ isset($user) ?  asset($user->image) : "" }}" class="img-fluid" style="max-height: 100px;" id="profileImage">
                            </div>
                        </div>
        ...
        $(document).ready(function ()
        {
            $('#btnSave').click(function () {
                if(username.val().trim() === "" || username.val().trim() == null)
                {
                    Swal.fire({
                        title: "Uyarı",
                        text: "Kullanıcı Adı Alanı Boş Geçilemez",
                ...
                else if(name.val().trim() === "" || name.val().trim() == null)
                {
                    Swal.fire({
                        title: "Uyarı",
                        text: "Kullanıcı Adı ve Soyadı Alanı Boş Geçilemez",
                        confirmButtonText: 'Tamam',
                        icon: "info"
                    });
                }
