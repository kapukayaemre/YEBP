                ...
                <section class="categories bg-white shadow-sm">
                    ...
                    <ul class="list-group m-0">
                        @foreach($categories as $category)
                            <li class="px-3 py-3">
                                <a href="{{ route("front.category", ['slug' => $category->slug]) }}">{{ $category->name }}
...
<footer class="container-fluid mt-5 p-5 bg-white" style="border-top: 1px solid #eceff2;">
    <div class="container text-center">
        ...
        {!! "&copy;". date("Y") ." ". $settings->footer_text !!}
{{--        <p>--}}
{{--            &copy; 2023 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis, soluta?--}}
{{--        </p>--}}
    </div>
</footer>
